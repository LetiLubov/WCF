...
namespace WCF_lab4_
{
    ...
    public class MyUlmartService : IMyUlmartService
    {
        ...
        public MyProduct GetProductByKeyword(String htmlHref)
        {
        ...
        HtmlNodeCollection ParseUlmartByKeyword(String htmlHref) //ИЩЕТ товары по ключевому слову на сайте
        {
        ...
        String GetHrefOnLastProductInList(String htmlHref)
        {
            HtmlWeb web = new HtmlWeb();
            HtmlNodeCollection nodes;
            String parameter = "";
        ...
        MyProduct isProductInDB(int parameter) //в nosql проверяем наличие товара и выдаем инфу, если есть
        {
        ...
        MyProduct FindInfoAboutProductWithPasrsingUlmart(String parameter) //неделима. Получает инфу о товаре. 
        {
            HtmlDocument document = null;
            HtmlWeb web = new HtmlWeb();
        ...
        void InsertInLiteDB(MyProduct p) //в nosql проверяем наличие товара и выдаем инфу, если есть
        {
